...
<div class="post-container">
    ...
    <div id="edit-post-popup" class="<?php echo (isset($id) ? 'show': 'hide'); ?>">
        <div class="modal-content">
            ...
            <form action="" method="post" enctype="multipart/form-data">
            <input type="text" name="edit_course_code" value="<?php echo isset($old_data['course_code']) ? $old_data['course_code'] : ''; ?>">
<input type="text" name="edit_course_name" value="<?php echo isset($old_data['course_name']) ? $old_data['course_name'] : ''; ?>">
<input type="text" name="edit_course_des" value="<?php echo isset($old_data['course_des']) ? $old_data['course_des'] : ''; ?>">
    ...
    <div class="move-center">
        <center>
            <button type="submit" onclick="toggleVisibility('add-post-popup')" class="new-post-btn"> Share Something </button>
            <button type="submit" onclick="window.location.href='<?php echo PAGES['request']; ?>'" class="new-post-btn"> Seek help </button>
